...
public class ServiceTask1 {
  ...
  {
            Response<Map> value = Rest.post("https://api.twilio.com/2010-04-01/Accounts/ACae83d19c19fca0ca6ac09a4182d604ea/Messages.json").
                queryParam("To", "+21653695025").
                queryParam("From", "+19802178485").
                queryParam("Body", "Eat de la demande :Encours Ref: "+id).
                header("Authorization", "Basic " + Base64.encodeNoNewline(("ACae83d19c19fca0ca6ac09a4182d604ea" + ":" + "2d36dca0b3fd3fc894182f6774786770").getBytes())).
                getAsJsonMap();
