...
import com.mobilePIDEV.entites.employer;
...
public class ServiceUtilisateur {
    ...
    public ArrayList<employer> users;
    ...
    public void signup(TextField username,TextField email,TextField password,TextField confpassword ,TextField num,TextField localisation,TextField categorie,TextField img, Resources rs ){
                String url = Statics.BASE_URL+"/employer/addEMJSON/new?username="+username.getText().toString()+"&password="+password.getText().toString()+"&email="+email.getText().toString()+"&num="+num.getText().toString()+"&localisation="+localisation.getText().toString()+"&categorie="+categorie.getText().toString()+"&img="+img.getText().toString();
                req.setUrl(url);
            
            
            if(username.getText().equals(" ") && localisation.getText().equals(" ") && email.getText().equals(" ") && password.getText().equals(" ") ){
    ...
    public void signin(TextField email,TextField password, Resources rs ){
        ...
        String url = Statics.BASE_URL+"/employer/singin/new?email="+email.getText().toString()+"&password="+password.getText().toString();
       req = new ConnectionRequest(url, false);
        ...
        req.addResponseListener((e) ->{
            ...
            Dialog.show("Echec d'authentification"," Email ou password incorrect ","OK",null);
             ...
             Dialog.show("Echec d'authentification","  password incorrect ","OK",null);
    ...
    //    Form userForm = new UserForm(name, (EncodedImage) theme.getImage("user.png"), url);
     //   userForm.show();
        ...
        String url = Statics.BASE_URL+"/employer/updatePass?id="+id+"&password="+newpassword;
          //  req = new ConnectionRequest(url, false);
            req.setUrl(url);
        ...
        public void newPassword(TextField password , String email , Resources rs){
         ...
         String url = Statics.BASE_URL+"/employer/newpassword/new?email="+email+"&password="+password;
               req.setUrl(url);
